    ...
    <section className="w-full pt-20 pb-20 bg-[#000319]" id="collaboration">
      <div className="mx-auto px-6">
        ...
        <div className="flex flex-wrap gap-6 justify-center">
          {/* Step 1: Red Card */}
          <div className="relative bg-black-200 p-8 rounded-lg border border-red-700 shadow-lg hover:shadow-lg hover:shadow-red-700/[0.5] w-full max-w-[300px] h-auto lg:h-[350px] flex flex-col justify-between">
          ...
          {/* Step 2: Orange Card */}
          <div className="relative bg-black-200 p-8 rounded-lg border border-orange-500 shadow-lg hover:shadow-lg hover:shadow-orange-500/[0.5] w-full max-w-[300px] h-auto lg:h-[350px] flex flex-col justify-between">
            <div className="flex justify-between items-center mb-4">
          ...
          {/* Step 3: Yellow Card */}
          <div className="relative bg-black-200 p-8 rounded-lg border border-yellow-400 shadow-lg hover:shadow-lg hover:shadow-yellow-400/[0.5] w-full max-w-[300px] h-auto lg:h-[350px] flex flex-col justify-between">
            <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex flex-wrap gap-6 justify-center mt-6">
          {/* Step 4: Green Card */}
          <div className="relative bg-black-200 p-8 rounded-lg border border-green-500 shadow-lg hover:shadow-lg hover:shadow-green-500/[0.5] w-full max-w-[300px] h-auto lg:h-[350px] flex flex-col justify-between">
            <div className="flex justify-between items-center mb-4">
          ...
          {/* Step 5: Blue Card */}
          <div className="relative bg-black-200 p-8 rounded-lg border border-blue-500 shadow-lg hover:shadow-lg hover:shadow-blue-500/[0.5] w-full max-w-[300px] h-auto lg:h-[350px] flex flex-col justify-between">
            <div className="flex justify-between items-center mb-4">
