...
const steps = [
  {
    ...
    description: (
      <>
        Identification du client idéal, des personas clés et des signaux
        d’intention à suivre.
        <br />
        Cette étape permet de concentrer les efforts uniquement sur les
  ...
  },
  {
    ...
    description: (
      <>
        Scraping et tri de la donnée : taille, secteur, rôle, géo, levées de
        fonds, signaux forts.
        <br />
        On s’assure d’avoir une base ultra-ciblée pour maximiser les taux de
        réponse dès le départ.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Grâce à cela, chaque message est ultra-personnalisé et pertinent pour
        son destinataire.
      </>
    ),
  ...
  {
    icon: <FaCheckDouble className="text-primary text-2xl" />,
    title: "Création de campagnes",
    description: (
      <>
        Copywriting + séquences multicanales : email, LinkedIn, WhatsApp, SMS si
        pertinent.
        <br />
        On met en place une stratégie d’approche automatisée mais humaine,
        pensée pour engager.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Routage des réponses, alertes Slack, filtres de booking ou
        désinscription auto.
        <br />
        Cela permet de ne jamais rater une réponse chaude et de gagner un temps
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <br />
        Le résultat : des rendez-vous qualifiés et une équipe commerciale qui se
        concentre uniquement sur les bons prospects.
      </>
    ),
    tools: toolMap.rdv,
  },
...
const ProcessAndStack = () => {
  return (
    <section
      className="max-w-7xl mx-auto px-4 md:px-10 pb-20 flex flex-col gap-12 items-center justify-center"
      id="strategie"
    >
      {/* Titre principal */}
      <div className="text-center max-w-3xl">
        <h2 className="text-4xl font-bold text-foreground mb-6">
          Notre <span className="text-primary">approche multicanal</span> étape
          par étape
        </h2>
        <p className="text-foreground text-lg font-medium mb-4">
          Nous accompagnons nos clients à chaque étape de la prospection
          multicanal, en automatisant les tâches les plus chronophages pour
