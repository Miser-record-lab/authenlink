...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 h-full max-h-[400px] w-full max-w-lg rounded-xl border mx-auto",
        className
      )}
    >
      ...
      <pre className="p-2 sm:p-4 overflow-x-auto">
        <code className="grid gap-y-1 text-xs sm:text-sm">{wrappedChildren}</code>
      </pre>
    </div>
  )
